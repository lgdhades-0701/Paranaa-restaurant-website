...
export const UIProvider: React.FC = (props) => {
  ...
  const setCategory = (_value: string) =>
    dispatch({ type: 'SET_CATEGORY', value: _value });
  
  const setMealType = (_value: string) =>
    dispatch({ type: 'SET_MEALTYPE', value: _value });
  
  const setFilterDate = (_value: string) =>
    dispatch({ type: 'SET_FILTERDATE', value: _value });
