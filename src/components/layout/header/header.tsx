...
import GroceryIcon from '@components/icons/featured/grocery-icon';
      ...
      <div className="z-20 w-screen transition-all duration-200 ease-in-out innerSticky lg:w-full body-font bg-fill-secondary">
        ...
        <Container className="flex items-center justify-between h-16 py-3 top-bar lg:h-auto">
          ...
          <div className="flex shrink-0 -mx-2.5 xl:-mx-3.5">
            <div className="xl:mx-3.5 mx-2.5 py-1 ">  
              <LanguageSwitcher />
            </div>
            <div className="xl:mx-3.5 mx-2.5 py-1 ">  
          <button className='bg-white hover:bg-green-500  appearance-none py-1 pl-2 pr-2  bg-clip-padding bg-no-repeat border border-solid border-green-600 rounded transition ease-in-out m-0  hover:bg-green focus:text-white hover:text-white'>Grocery</button>
            </div>
            ...
            <div className="flex items-center ltr:ml-auto rtl:mr-auto shrink-0">
              ...
              <div className="flex items-center w-0 py-4 overflow-hidden transition-all duration-200 ease-in-out opacity-0 navbar-right">
                <button
                  ...
                  onClick={() => openSearch()}
                  title="Search toggle"
                  className="flex items-center justify-center w-12 h-full transition duration-200 ease-in-out outline-none ltr:mr-0 rtl:ml-3 md:w-14 hover:text-heading  focus:outline-none"
                >
                  <SearchIcon className="w-[22px] h-[22px] text-brand-dark text-opacity-40" />
                </button>

                <div className="flex sticky-search xl:mx-3.5 mx-3.5">  
          <button className=' bg-white hover:bg-green-500  appearance-none py-1 pl-3 pr-3  bg-clip-padding bg-no-repeat border border-solid border-green-600 rounded transition ease-in-out  hover:bg-green focus:text-white hover:text-white'>Grocery</button>
            </div>
